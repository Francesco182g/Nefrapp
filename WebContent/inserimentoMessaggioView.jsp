					...
					<div class="card-body ">
						<form class="user" action="./messaggio" method="POST">
								...
								<div class="col-lg-3 col-sm-3 mb-3 mb-sm-12 row">
									...
									<!-- Se utente==paziente, il pulsante mostra l'elenco dei medico, viceversa altrimenti -->
										<button class="btn btn-secondary dropdown-toggle"
											...
											aria-haspopup="true" aria-expanded="false">Elenco Medici
											</button>
									...
									<input type="text"
											class="form-control form-control-user" id="destinatario" name="destinatario"
							...
							<div class="form-group row">
								...
								<div class="col-lg-12 col-mb-12 col-sm-12 mb-12 mb-sm-12 row">
									<textarea name="testo" maxlength="1000" id="testo" class="form-control " placeholder="" required="required" style="resize: none;height:180px"></textarea>
								</div>
							</div>
							<div class="form-group row">
							...
							<div class="form-group row">
							<button class="btn btn-primary btn-user" type="submit" id="inviaMessaggio" style="float:right">
							Invia Messaggio 
							</button>
							</div>
