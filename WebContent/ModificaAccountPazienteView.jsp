		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<c:if test="${isAmministratore == true}">
					<c:set var="azione"
						value="./GestioneAmministratore?operazione=modifica"></c:set>
				</c:if>
				<c:if test="${isPaziente == true}">
					<c:set var="azione"
						value="./GestionePaziente?operazione=modificaAccount"></c:set>
										...
										<form id="modificaForm" class="user" method="post"
											...
											<div class="form-group row col-lg-12">
												Codice Fiscale: <input type="text"
													...
													id="codiceFiscale" value="${codiceFiscale}" readonly>
											</div>
											...
											<div class="form-group row col-lg-12">
												Data di nascita: <input type="text"
													...
													name="dataDiNascita" value="${dataDiNascita}"
													autocomplete="off">
											</div>
											<div class="form-group row col-lg-12">
											...
											<div class="col-sm-5 sm-12"
												...
												<button type="submit"
													...
													id="registrazioneButton" form="modificaForm">
													Modifica</button>
											</div>
										</form>
