		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content-stretched">
				...
				<div class="container-fluid">
					<c:if test="${notifica == 'CFnonPresente'}">
						<div class="alert alert-warning alert-dismissible fade show"
							role="alert">
							Il Codice Fiscale inserito non appartiene a nessun utente
							registrato.
									...
									<div class="col-sm-12">
										<div class="card o-hidden border-0 shadow-sm p-5">
											...
											<form class="user" method="post"
												...
												<!-- TODO controllo in js per il formato dell'email -->
												...
												<div class="mt-6 p-6">
													<button class="btn btn-primary btn-user" type="submit"
														id="richiestaReset" style="float: right">Invia
														richiesta</button>
												</div>
											</form>
