...
public class AmministratoreModel {
  ...
  /**
   * Questo metodo si occupa di verificare se i dati immessi dall'amministratore per 
   * effettuare il login sono presenti nel database.
   *
   * @param codiceFiscale oggetto di tipo <strong>String</strong> 
   *        che rappresenta il codice fiscale dell'amministratore.
   * @param password oggetto di tipo <strong>String</strong> 
   *        che rappresenta la password dell'amministratore.
   * 
  ...
  public static Amministratore getAmministratoreByCFPassword(String codiceFiscale, String password) {
    MongoCollection<Document> amministratori =
   ...
   *        che rappresenta il codice fiscale dell'amministratore.
   * 
   * @return password oggetto di tipo <strong>String</strong> 
   *         che rappresenta la password dell'amministratore.
   * 
