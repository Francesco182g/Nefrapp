...
public class MedicoModel {
  ...
  /**
   * Questo metodo si occupa di verificare se i dati immessi dal medico 
   ...
   * 
   * @param daAggiungere oggetto di tipo <strong>Medico</strong>
   *        che rappresenta il medico da aggiungere.
   * @param password oggetto di tipo <strong>String</strong> 
   *        che rappresenta la password del medico da aggiungere.
   * 
   ...
   * 
   * @param daRimuovere oggetto di tipo <strong>String</strong>
   *        che rappresenta il codice fiscale del medico da rimuovere.
   * 
   ...
   * 
   * @param daAggiornare oggetto di tipo <strong>Medico</strong>
   *        che include i nuovi dati del medico.
   * 
  ...
  /**
   * Questo metodo si occupa di ricercare e restituire tutti i medici 
   * che seguono un determinato paziente.
   * 
   ...
   *        che rappresenta l'indirizzo email del medico.
   * 
   * @return medico oggetto di tipo <strong>Medico</strong>, altrimenti null.
   * 
   ...
   *
   * @param codiceFiscale oggetto di tipo <strong>String</strong>
   *        che rappresenta il codice fiscale del medico al quale bisogna aggiornare la password.
   * @param nuovaPassword oggetto di tipo <strong>String</strong> 
   *        che rappresenta il nuovo valore della password.
   * 
  ...
  /**
   * Questo metodi si occupa di verificare che la mail che inserisce
   * il medico non sia già presente. 
