...
public class PianoTerapeuticoModel {
   ...
   * 
   * @param daAggiungere oggetto di tipo <strong>PianoTerapeutico</strong> 
   *        che rappresenta il piano terapeutico da aggiungere.
   * 
   * @precondition daAggiungere != null.
   */
  public static void addPianoTerapeutico(PianoTerapeutico daAggiungere) {
    MongoCollection<Document> pianoTerapeutico = 
        DriverConnection.getConnection().getCollection("PianoTerapeutico");
  ...
  /**
   * Questo metodo si occupa di ricercare il piano terapeutico di un 
   * paziente tramite il suo codice fiscale.
   * 
  ...
  public static PianoTerapeutico getPianoTerapeuticoByPaziente(String codiceFiscalePaziente) {
    ...
    MongoCursor<Document> documenti = 
        pianoTerapeuticoDB.find(eq("PazienteCodiceFiscale", codiceFiscalePaziente))
        .iterator();
   ...
   * 
   * @param daAggiornare oggetto di tipo <strong>PianoTerapeutico</strong> 
   *        che include i nuovi dati del piano terapeutico.
   * 
  ...
  /**
   * Questo metodo si occupa di controllare se il piano terapeutico 
   * di un paziente è stato visualizzato.
   * 
   * @param codiceFiscalePaziente oggetto di tipo <strong>String</strong> 
   *        che rappresenta il codice fiscale del paziente.
   * 
   * @return oggetto di tipo <strong>Boolena</strong> 
   *         che indica se è stato visualizzato (true) oppure no (false).
   * 
   * @precondition codiceFiscalePaziente != null.
   */
   ...
   *        che rappresenta lo stato di visualizzazione da settare del piano terapeutico.
   * 
   * @precondition codiceFiscalePaziente != null.
   */
  public static void setVisualizzatoPianoTerapeutico(String codiceFiscalePaziente,
      Boolean visualizzato) {
    MongoCollection<Document> pianoTerapeuticoDB = 
        DriverConnection.getConnection().getCollection("PianoTerapeutico");
   ...
   * 
   * @param codiceFiscalePaziente oggetto di tipo <strong>String</strong> 
   *        che rappresenta il codice fiscale del paziente al quale è collegato 
   *        il piano terapeutico da rimuovere.
   * 
   * @precondition codiceFiscalePaziente != null.
   */
