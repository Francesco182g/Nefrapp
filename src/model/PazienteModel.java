...
public class PazienteModel {
   ...
   *        che rappresenta la password del paziente.
   * 
   ...
   * 
   * @param daAggiungere oggetto di tipo <strong>Paziente</strong> 
   *        che rappresenta il paziente da aggiungere.
   * @param password oggetto di tipo <strong>String</strong> 
   *        che rappresenta la password del paziente da aggiungere.
   * 
  ...
  public static String getIdPazienteByCF(String codiceFiscale) {
    ...
    if (datiPaziente != null) {
      String pazienteID = 
          CriptazioneUtility.criptaConMD5(datiPaziente.getObjectId("_id").toString());
      return pazienteID;
    }
    return null;
  }
   ...
   *        che rappresenta il codice fiscale del paziente da rimuovere.
   * 
   ...
   * 
   * @param daAggiornare oggetto di tipo <strong>String</strong> 
   *        che rappresenta il codice fiscale del paziente al quale bisogna aggiornare la password.
   * @param password oggetto di tipo <strong>String</strong> 
   ...
   * 
   * @param daAggiornare oggetto di tipo <strong>Paziente</strong> 
   *        che include i nuovi dati del paziente.
   * 
