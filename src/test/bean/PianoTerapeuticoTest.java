...
class PianoTerapeuticoTest {
	...
	private static final String diagnosi = "Gentilissimo paziente, dopo aver attentamente analizzato i suoi andamenti nella scorsa settimana"
												+ " ho deciso di apportare delle modifiche al suo piano terapeutico. "
												+ "Le modifiche sono le seguenti: Lasix da 2 volte al giorno a 1 volta al giorno. Buona giornata.";
	...
	void testGetCodiceFiscalePaziente() {
		PianoTerapeutico piano = new PianoTerapeutico("DWNRRT85E18I483W", diagnosi, "Lasix 1x 25g", dataFineTerapia);
	...
	void testSetDiagnosi() {
		PianoTerapeutico piano = new PianoTerapeutico("DWNRRT85E18I483W", "", "Lasix 1x 25g", dataFineTerapia);
	...
	@Test
	void testSetFarmaco() {
		PianoTerapeutico piano = new PianoTerapeutico("DWNRRT85E18I483W", diagnosi, "", dataFineTerapia);
	...
	void testSetDataFineTerapia() {
		PianoTerapeutico piano = new PianoTerapeutico("DWNRRT85E18I483W", diagnosi, "Lasix 1x 25g", dataNull);
