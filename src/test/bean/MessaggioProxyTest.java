...
class MessaggioProxyTest {
	...
	void testToString() {
		...
		String toStringTest = "MessaggioProxy [idMessaggio=" + MessaggioProxy.getIdMessaggio() + ", codiceFiscaleMittente=" + MessaggioProxy.getCodiceFiscaleMittente()
				+ ", oggetto=" + MessaggioProxy.getOggetto() + ", data=" + MessaggioProxy.getData()+ ", visualizzato=" + MessaggioProxy.getVisualizzato()
