...
class PazienteModelTest {
	...
	void testGetPazienteByCFPassword() {
		Paziente paziente = PazienteModel.getPazienteByCFPassword("RSSGPP79E16I483P", "PasswordDifficile");
	...
	void testChangePassword() {
		...
		Paziente paziente = PazienteModel.getPazienteByCFPassword("RSSGPP79E16I483P", "NuovaPasswordBella");
		assertNotNull(paziente);
	}
