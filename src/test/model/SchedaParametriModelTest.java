...
class SchedaParametriModelTest {
	...
	void testAddSchedaParametri() {
		...
		ArrayList<SchedaParametri> schedeParametri = SchedaParametriModel.getSchedeParametriByCF("RFFGPP79E16I483P");
	...
	void testGetReportByPaziente() {
		ArrayList<SchedaParametri> schedeParametri = SchedaParametriModel.getReportByPaziente("RFFGPP79E16I483P", dataInizio, dataFine);
		assertNotNull(schedeParametri);
