...
public class CriptazioneUtility {
  ...
  // può essere affrontato soltanto in deployment con infrastrutture dedicate (HSM)
  // e separate sia dalla webapp che dal database. Il codice non dovrebbe mai trattare con le vere 
  // chiavi di decriptazione, nemmeno in forma indiretta e/o derivata
   ...
   * @param base64 booleano da settare a true se si vuole ricevere una stringa 
   *        in base64 e false altrimenti
