...
public class GestioneMedico extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(operazione.equals("modifica")) {
				request.setAttribute("notifica","Modifica effettuata con successo"); //Se ci� non avviene la stringa viene cambiata dal metodo
	...
	private boolean validazione(String codiceFiscale, String nome, String cognome, String sesso, String email, String residenza, String luogoDiNascita, String dataDiNascita, String password, String confermaPsw) {
