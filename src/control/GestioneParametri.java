...
public class GestioneParametri extends HttpServlet {
  ...
  /**
   * Questo metodo richiama dal database la lista delle schede parametri inserite da 
   * un determinato utente. Nel caso in cui la visualizzazione sia richiesta da un 
   * paziente, esso è richiamato dalla sessione, nel caso in cui la visualizzazione 
   * sia richiesta da un medico, il CF del paziente di cui mostrare le schede
   ...
   * 
   * @param cf da inserire
   * @param peso da inserire
   * @param paMin da inserire
   * @param paMax da inserire
   * @param scaricoIniziale da inserire
   * @param uf da inserire
   * @param tempoSosta da inserire
   * @param scarico da inserire
   * @param carico da inserire
   * @param data da inserire
   * 
   * @author nico
   ...
   * @param newPeso da validare
   * @param newPaMin da validare
   * @param newPaMax da validare
   * @param newScaricoIniziale da validare
   * @param newUf da validare
   * @param newTempoSosta da validare
   * @param newScarico da validare
   * @param newCarico da validare
   * @return
   */
  private boolean sonoValidi(String cf, BigDecimal newPeso, int newPaMin, 
      int newPaMax, int newScaricoIniziale, int newUf,
  ...
  /**
   * Questo metodo preleva le schede parametri per un dato intervallo di tempo
   * e inserisce i parametri in un file excel.
   * 
   * @author Matteo Falco
   */
