...
public class GestionePaziente extends HttpServlet {
  ...
  /**
   * Metodo che preleva il paziente che richiede la disattivazione del proprio account 
   * e lo inserisce nella richiesta.
  ...
  private boolean validazione(String codiceFiscale, String nome, String cognome, 
      String sesso, String email, String residenza, String luogoDiNascita, 
      String dataDiNascita, String password, String confermaPsw) {
