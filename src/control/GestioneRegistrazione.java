...
public class GestioneRegistrazione extends HttpServlet {
   ...
   * codiceFiscale.lenght()==16, nome != null && nome.matches("^[A-Z][a-zA-Z ]*$")
   * && (nome.lenght()>1 && nome.lenght() < 31), cognome != null &&
   * cognome.matches("^[A-Z][a-zA-Z ]*$") && (cognome.lenght() > 1 &&
   * cognome.lenght() < 31), sesso != null && sesso.matches("^[MF]$") &&
   * sesso.lenght() == 1, email != null &&
   * email.matches("^[A-Za-z0-9_.-]+@[a-zA-Z.]{2,}\\.[a-zA-Z]{2,3}$"), password !=
   * null && password.matches("^[a-zA-Z0-9]*$") && (password.lenght() > 4 &&
   * password.lenght() < 21),
   * 
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      else if (operazione.equals("registraPazienteMedico")) { 
        // registrazione paziente per il medico
          ...
          if (registrato.equals("No")) { // paziente non registrato
            ...
            if (PazienteModel.getPazienteByCF(codiceFiscale) != null) {
              ...
              RequestDispatcher requestDispatcher = request
                  .getRequestDispatcher("/registraPazienteMedico.jsp");
  ...
  /**
   * Metodo che inserisce un Medico nel database. 
